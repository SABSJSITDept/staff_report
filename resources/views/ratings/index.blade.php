...
<div class="space-y-6">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <form action="{{ route('ratings.index') }}" method="GET" class="flex flex-col sm:flex-row gap-3">
            ...
            <select name="office_id" id="office_id_select" class="rounded-xl border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 bg-white py-2 px-3 transition-colors" onchange="filterStaffByOffice()">
